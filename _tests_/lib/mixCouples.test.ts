...
describe('mixCouples', () => {
    ...
    it('returns first couple with a leader and a follower', () => {
        const finalCouples: MixedCouple[] = mixCouples(followers, leaders, luckyNumber);
    ...
    it('returns each couple with a leader and a follower', () => {
        const finalCouples: MixedCouple[] = mixCouples(followers, leaders, luckyNumber);
        finalCouples.forEach((couple: MixedCouple) => {
    ...
    it('returns first follower in the first couple if the leaders are rotating', () => {
        const finalCouples: MixedCouple[] = mixCouples(followers, leaders, luckyNumber, true);
    ...
    for (let i = 0; i < 10; i++) {
        it('rotates leaders when leaders should be rotating', () => {
            ...
            const finalCouples: MixedCouple[] = mixCouples(followers, leaders, luckyNumber, leadersRotating);
